...
// ===========================================================================
/*@TypeMatching private[gallia]*/
/*private[dyn] */object DataFormatting { import aptus._

  def format(value: Any/*NakedValue*/): String = NakedValueFormatter.format(value)
  ...
  // borrowed from gallia (TODO: t241130165320 - refactor)
                            ...
                            def formatBinary(bytes: ByteBuffer): String =
                              bytes
                                .array
                                .toBase64
                                .prepend(DataParsing.Base64StringPrefix) }
